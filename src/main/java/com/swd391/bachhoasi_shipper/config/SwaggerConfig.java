...
public class SwaggerConfig {
    ...
    public OpenAPI openAPI() {
        ...
        contact.setEmail("bachhoasi@gmail.com");
        contact.setName("SWD391");

        License mitLicense = new License().name("MIT License").url("https://choosealicense.com/licenses/mit/");

        Info info = new Info()
            .title("BACH HOA SI API ENDPOINT")
            .version("1.0")
            .contact(contact)
            .description("REST API ENDPOINT USING SPRING BOOT FOR BACH HOA SI").termsOfService("https://github.com")
            .license(mitLicense);
