package com.swd391.bachhoasi_shipper.config;
...
import com.swd391.bachhoasi_shipper.security.BachHoaSiAuthenticationEntryPoint;
import com.swd391.bachhoasi_shipper.security.JwtAuthenticationFilter;
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                ...
                http.csrf(AbstractHttpConfigurer::disable)
                                ...
                                .authorizeHttpRequests(authorize -> authorize
                                        ...
                                        .requestMatchers(HttpMethod.POST, "/shippers").permitAll()
